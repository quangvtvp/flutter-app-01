...
//           flex: 1,
//           child: Container(color: Colors.red, height: 75, child: Text('hello'),),
//         ),
//         Expanded(
//           flex: 1,
//           child: Container(color: Colors.blue, height: 75,child: Text('flluter'),),
//         ),
//       ],
//     );
//   }
...
//         Expanded(
//           flex: 1,
//           child: Container(color: Colors.grey, width: 100, height: 75,child: Center(child: Text('flluter',style:TextStyle(color: Colors.orange,fontSize: 50))),
//         ),
//        ],
//     );
//   }
