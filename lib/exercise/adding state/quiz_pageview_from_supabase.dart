...
class QuizTakePage extends StatefulWidget {
  ...
  const QuizTakePage(
      {super.key, required this.examId, required this.dataService});
...
class _QuizTakePageState extends State<QuizTakePage>
  ...
  void initState() {
    ...
    _examFuture = widget.dataService.getExamDetail(widget.examId);
  }
  ...
  void _submitQuiz() async {
    ...
    final (score, results) =
        await widget.dataService.submitExam(_examDetail!.id, answers);
